...
const categories: FAQCategory[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Free users get 1 analysis to see the value. Starter ($29/mo) and Pro ($99/mo) get unlimited analyses. Enterprise ($699/mo) includes API access and team collaboration. Admin emails have unlimited quotas."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "We offer 4 tiers: Free (1 CLEANBI analysis, basic calculators), Starter ($29/mo - unlimited analyses, all calculators), Pro ($99/mo - unlimited analyses, PDF reports, ROI calculators, API access), Enterprise ($699/mo - everything in Pro plus ownership data, team features, white-label, priority support)."
      },
      {
