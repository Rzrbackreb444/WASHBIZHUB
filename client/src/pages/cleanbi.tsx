  ...
  return (
    <>
      <SEO 
        ...
        description="Score any laundromat location in seconds with CLEANBI™. Free A/B/C grades, competition mapping, demographics analysis, and AI-powered insights. Industry-standard 17-factor scoring system trusted by 5,600+ operators. Free tier includes 5 analyses total."
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6 sm:space-y-8 px-6">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleGenerateInsights)} className="space-y-6 sm:space-y-8">
                ...
                <Button 
                  type="submit"
                  className="w-full btn-premium-gold text-white font-semibold text-lg py-6"
