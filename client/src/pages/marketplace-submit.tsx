...
import { CheckCircle, Upload, ArrowLeft, Loader2, ShoppingBag, Store, Wrench, Building2 } from "lucide-react";
...
export default function MarketplaceSubmit() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-background">
        <Helmet>
          <title>Listing Submitted | WashBizHub Marketplace</title>
        </Helmet>
            ...
            <CardContent className="pt-12 pb-8">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                ...
                <Button asChild variant="outline" onClick={() => setSubmitted(false)}>
                  <span>Submit Another Listing</span>
                </Button>
              </div>
            </CardContent>
          </Card>
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Sell Equipment, Services or Business | WashBizHub Marketplace</title>
      ...
      <div className="bg-gradient-to-r from-[#001F3F] to-[#0d4f8b] text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Sell on WashBizHub Marketplace</h1>
