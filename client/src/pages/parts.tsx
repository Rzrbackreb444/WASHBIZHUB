      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70" data-testid="text-parts-subtitle">
            2,800+ fault codes with genuine replacement parts
          </p>
        </div>
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20 mb-8">
              <CardHeader>
                ...
                <CardDescription className="text-white/70">
                  Search our database of 2,800+ diagnostic codes
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-accent/20 backdrop-blur border-accent/30 mt-8">
              <CardContent className="p-6 text-center">
                <p className="text-white/90">
                  ...
                  database of 2,800+ diagnostic codes with step-by-step repair guides.
                </p>
                <Button 
