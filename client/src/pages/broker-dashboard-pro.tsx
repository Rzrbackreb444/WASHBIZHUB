            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h1 className="text-4xl font-bold text-foreground">Broker Analytics</h1>
                </div>
                <p className="text-muted-foreground">Real-time performance tracking & lead management</p>
              </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {TOP_METRICS.map(metric => (
                <div key={metric.label} className="bg-card border rounded-lg p-4">
                  ...
                  <div className="text-xs text-green-600 mt-1">{metric.trend} vs last period</div>
                </div>
              ))}
            </div>
          </div>
