...
export const PLATFORM_TIERS: Record<PlatformTier, PlatformTierConfig> = {
  free: {
    ...
    description: 'Perfect for exploring the platform and trying CLEANBI',
    price: 0,
    priceAnnual: 0,
    icon: Gift,
    ...
    popular: false,
    features: [
      { text: '1 CLEANBI analysis per day', included: true },
      ...
      { text: 'Save analyses to history', included: true },
