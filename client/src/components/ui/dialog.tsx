...
>(({ className, children, ...props }, ref) => {
  ...
  const hasUserDescription = React.Children.toArray(children).some(
    (child) => 
  ...
  const needsFallback = !hasUserDescription && !props['aria-describedby'];
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={needsFallback ? fallbackDescId : props['aria-describedby']}
        className={cn(
