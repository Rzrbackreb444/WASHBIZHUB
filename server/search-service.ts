...
const STATIC_PAGES_DATA = [
  ...
  { url: "/startup-funding", title: "Startup Funding Guide", description: "Complete guide to funding a new laundromat. Explore financing options, requirements, and strategies.", category: "Funding", keywords: ["startup", "funding", "new business", "financing", "capital"] },
